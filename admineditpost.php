...
<h1 style="color:forestgreen;text-align:center">EDIT POST</h1>
<?php 
$status = "";
...
$quantity = $_REQUEST["quantity"];
  ...
  $update="update post set  email='".$email."',
productname='".$productname."', price='".$price."', image='".$image."', quantity='".$quantity."'where email='".$email."'";  
