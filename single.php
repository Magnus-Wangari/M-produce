...
if(isset($_GET['id']) & !empty($_GET['id'])){
    $id = $_GET['id'];
    $prodsql = "SELECT * FROM post WHERE postid = $id";
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 product-single">
                            ...
                            <div class="p-price">KES <?php echo $prodr['price']; ?>.00/-</div>
                            ...
                            <div class="product-meta">
								<span>Categories:
                                    ...
                                    $prodcatres = mysqli_query($conn, $prodcatsql);
                                ...
                                while($relr = mysqli_fetch_assoc($relres)){
                                    ...
                                    <div class="sm-item isotope-item">
                                        <div class="product">
                                            ...
                                            <div class="product-price">KES <?php echo $relr['price']; ?>.00/-<span></span></div>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
